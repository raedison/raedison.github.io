...
```{R}
ggplot(poke, aes(x=Attack_c*Defense_c, y=HP_c))+geom_point()+  geom_smooth(method="lm",se=F,fullrange=T,) + ggtitle("Linear Regression of Predicting HP stats from Attack and Defense stats of Pokemon")
```
