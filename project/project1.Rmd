...
datarenamed <-dataclean%>%rename("2013_admittance"="2013.x", "2014_admittance"="2014.x","2015_admittance"="2015.x","2016_admittance"="2016.x","2017_admittance"="2017.x","2018_admittance"="2018.x","2019_admittance"="2019.x","2013_sat"="2013.y","2014_sat"="2014.y","2015_sat"="2015.y","2016_sat"="2016.y","2017_sat"="2017.y","2018_sat"="2018.y","2019_sat"="2019.y")
```
...
datarenamed %>% select(UTBranch, "2013_admittance", "2013_sat")
datarenamed %>% group_by(UTBranch)
datarenamed %>% summarize(mean("2015_admittance", na.rm=T), n(), n_distinct(UTBranch))
datarenamed %>% summarize(sd("2017_sat", na.rm=T), n(), n_distinct(UTBranch))
datarenamed%>% summarize(var("2014_admittance", na.rm=T), n(), n_distinct(UTBranch))
datarenamed %>% summarize(IQR("2016_admittance", na.rm=T), n(), n_distinct(UTBranch))
datarenamed %>% summarize(median("2019_sat", na.rm=T), n(), n_distinct(UTBranch))
```
...
```{R}
dataorganize1 <- datarenamed %>% pivot_longer(c("2013_admittance","2014_admittance","2015_admittance","2016_admittance","2017_admittance","2018_admittance","2019_admittance"), names_to="admittance_year", values_to="percent_admittance")
dataoragnize2 <- dataorganize1%>% pivot_longer(c("2013_sat","2014_sat","2015_sat","2016_sat","2017_sat","2018_sat","2019_sat"), names_to="year", values_to="avg_sat")
```
...
```{R}
ggplot(datarenamed,aes("2013_admittance","2013_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2013")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2014_admittance","2014_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2014")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2015_admittance","2015_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2015")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2016_admittance","2016_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2016")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2017_admittance","2017_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2017")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2018_admittance","2018_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2018")+xlab("Percent Admittance")+ylab("Average SAT Scores")
ggplot(datarenamed,aes("2019_admittance","2019_sat"))+geom_point(size=4, aes(color=UTBranch))+ggtitle("Admittance vs. Average SAT Scores: 2019")+xlab("Percent Admittance")+ylab("Average SAT Scores")
```
...
```{R}
clust_dat2013<-datarenamed%>%select("2013_admittance","2013_sat")
kmeans2013<-clust_dat2013%>%kmeans(3) 
kmeans2013
kmeans2013clust <-clust_dat2013%>%mutate(cluster=as.factor(kmeans2013$cluster))
kmeans2013clust%>%ggplot(aes("2013_admittance","2013_sat",color=cluster))+geom_point()
```
...
```{R}
clust_dat2014<-datarenamed%>%select("2014_admittance","2014_sat")
kmeans2014<-clust_dat2014%>%kmeans(3) 
kmeans2014
kmeans2014clust <-clust_dat2014%>%mutate(cluster=as.factor(kmeans2014$cluster))
kmeans2014clust%>%ggplot(aes("2014_admittance","2014_sat",color=cluster))+geom_point()
```
...
```{R}
clust_dat2019<-datarenamed%>%select("2019_admittance","2019_sat")
kmeans2019<-clust_dat2019%>%kmeans(3) 
kmeans2019
kmeans2019clust <-clust_dat2019%>%mutate(cluster=as.factor(kmeans2019$cluster))
kmeans2019clust%>%ggplot(aes("2019_admittance","2019_sat",color=cluster))+geom_point()
```
